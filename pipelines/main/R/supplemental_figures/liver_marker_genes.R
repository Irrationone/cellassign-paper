...
parser <- ArgumentParser(description = "Liver supplemental marker gene expression plot")
...
parser$add_argument('--marker_genes', type='character', nargs = '+',
                    help="Marker genes to use")
...
marker_genes <- unlist(args$marker_genes)
