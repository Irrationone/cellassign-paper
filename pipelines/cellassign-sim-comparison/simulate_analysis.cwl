...
steps:
    simulate_sce:
        ...
        scatter: [random_seed, num_cells, num_groups, num_batches, group_prob_dirichlet, batch_prob_dirichlet, de_facloc, de_facscale, de_facnu, de_prob, down_prob, batch_facloc, batch_facscale, base_sce_param]
