...
```{r, echo = FALSE}
plot_markers(pathway_timepoint_malignant$genes %>% as.data.frame %>% dplyr::mutate(is_significant = FDR <= 0.05), top_n = 10, log_q_val_threshold = NULL, nrow = 1, subtitle = "T2 vs. T1", top_direction = "equal", highlight_genes = c("TCL1A", "BCL2", "BCL6", "HLA-A", "HLA-B", "HLA-C", "FCER2", "CD74", "IFNG", "CD69", "LAG3", "HAVCR2"))
```
